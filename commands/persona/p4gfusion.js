...
module.exports = {
    ...
    run: async (client, message, args, query) => {
        ...
        switch (personaName) {
            ...
            case "izanagi":
                var name = "Izanagi";
                var url = "https://arantius.github.io/persona-fusion-calculator/4golden.html#/persona/Izanagi";
                var result1 = "12,700¥ | [Obariyon](https://arantius.github.io/persona-fusion-calculator/4golden.html#/persona/Obariyon) (13/Fool), [Yomotsu-Shikome](https://arantius.github.io/persona-fusion-calculator/4golden.html#/persona/Yomotsu-Shikome) (7/Fool)";
